    ...
    getPhotospotByLocation(
      ...
      if (photospot) {
        ...
        setSelectedLocation({
          ...
          neighborhood: suggestion.properties.context.neighborhood
            ? suggestion.properties.context.neighborhood.name
            : "",
          location_name: suggestion.properties.name_preferred
            ? suggestion.properties.name_preferred
