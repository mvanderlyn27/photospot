                ...
                <div className="w-full p-20">
                    <div className="grid items-center gap-12 lg:grid-cols-2">
                        ...
                        <div className="mb-12 lg:mb-0 relative w-full h-[600px] overflow-hidden">
                            <Image src="https://vkfbzrfveygdqsqyiggk.supabase.co/storage/v1/object/public/website_pictures/manhattanSunset3.JPG"
                                className="object-cover w-full rounded-lg shadow-lg dark:shadow-black/20" fill alt="" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full p-20">
                    <div className="grid items-center gap-12 lg:grid-cols-2">
                        <div className="mt-12 lg:mt-0 relative w-full h-[600px] overflow-hidden">
                            <Image src="https://vkfbzrfveygdqsqyiggk.supabase.co/storage/v1/object/public/website_pictures/home.JPG"
                                className="object-cover w-full rounded-lg shadow-lg dark:shadow-black/20" alt="" fill />
                        </div>
            ...
            <div className="px-6 py-12 text-center md:px-12 lg:my-12 lg:text-left">
                <div className="w-full p-20">
                    <div className="grid items-center gap-12 lg:grid-cols-2">
                        ...
                        <div className="mb-12 lg:mb-0 relative w-full h-[600px] overflow-hidden">
                            <Image src="https://vkfbzrfveygdqsqyiggk.supabase.co/storage/v1/object/public/website_pictures/mapPhotospots2.JPG"
                                className="object-cover w-full rounded-lg shadow-lg dark:shadow-black/20" alt="" fill />
                        </div>
                    </div>
                </div>
