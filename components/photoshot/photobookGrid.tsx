...
export default function PhotobookGrid({ input, photospot, user, updatePhotobook }: { input: Photoshot[], photospot: Photospot | null, user: UserIdentity, updatePhotobook: any }) {
