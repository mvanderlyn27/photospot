...
export default function EditPhotospotForm({ photospotName, setPhotospotName, setEditPhotospotsDialogOpen }: { photospotName: string, setPhotospotName: any, setEditPhotospotsDialogOpen: any }) {
