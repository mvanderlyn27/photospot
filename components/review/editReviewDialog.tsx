...
export default function EditReviewDialog({ review }: { review: Review | null }) {
    ...
    return (
        <div className="flex flex-col gap-2 ">
            {review && <Dialog open={reviewDialogOpen} onOpenChange={setReviewDialogOpen}>
                <DialogTrigger>
                ...
                <DialogContent>
                    ...
                    <EditReviewForm reviewData={review} setReviewDialogOpen={setReviewDialogOpen} />
                </DialogContent>
            </Dialog>}
        </div>
    )
