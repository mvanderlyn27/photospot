...
export default function CreateReviewForm({ photospot, setReviewDialogOpen }: { photospot: Photospot, setReviewDialogOpen: any }) {
    ...
    const createNewReview = async (data: z.infer<typeof createReviewSchema>): Promise<Review> => {
    ...
    const onCreate = async (data: z.infer<typeof createReviewSchema>) => {
        ...
        setSubmitting(true);
        await mutate('/api/photospot/' + photospot.id + '/reviews', createNewReview(data), {
