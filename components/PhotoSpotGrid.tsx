...
return (
  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 p-4 grid-flow-row-dense" >
    ...
    <div className='overflow-hidden  aspect-square cursor-pointer rounded relative group'>
      <Image className= "object-cover rounded w-full aspect-square group-hover:scale-110 transition duration-300 ease-in-out "src={photospot.photo_paths[0]} width={200} height={200} alt={photospot.name ? photospot.name : ""}/>
