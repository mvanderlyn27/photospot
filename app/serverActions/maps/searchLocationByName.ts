...
export async function suggestLocations(searchQuery: string, user_id: string | undefined, location: LngLat, bbox: LngLatBounds | undefined, sessionToken: SessionToken) {
...
export async function retrieveLocation(suggestion: SearchBoxSuggestion, user_id: string | undefined, sessionToken: SessionToken) {
    const search = new SearchBoxCore({ accessToken: mapBoxToken });
